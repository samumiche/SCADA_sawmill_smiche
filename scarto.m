...
eff = volume_totale_m3/volume_da_tagliare;

fprintf("Volume di legna iniziale: %.5f m^3 \n", volume_da_tagliare);
fprintf("Volume di legna prodotto: %.5f m^3 \n", volume_totale_m3 );
fprintf("Efficienza: %.2f%% \n", eff*100)
fprintf("Scarto: %.5f m^3 \n", volume_da_tagliare - volume_totale_m3);